      ...
      <div className="pt-24 pb-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="font-['Kalam'] text-4xl md:text-6xl font-bold text-gray-900 mb-4 leading-tight">
              ChainDiary: Your Moods, Secured on Solana
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <a
                ...
                className="flex items-center gap-2 px-6 py-2 border-2 border-gray-900 rounded-md bg-white hover:bg-gray-50 transition-all duration-200 hover:scale-105"
              >
            ...
            <Link
              href="/dashboard"
              className="bg-gray-900 hover:bg-gray-800 text-white font-medium py-4 px-8 rounded-md text-lg border-2 border-gray-900 transition-all duration-200 hover:scale-105 mb-16 inline-flex items-center gap-2"
            >
              Go to Dashboard
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-16">
            ...
            <div className="lg:col-span-1 bg-white border-2 border-gray-900 rounded-md p-6">
              <h3 className="font-['Kalam'] text-xl font-bold text-gray-900 mb-6">
                Write Your Entry
              </h3>
          ...
          <div className="bg-white border-2 border-gray-900 rounded-md p-8 mb-16">
            <h2 className="font-['Kalam'] text-3xl font-bold text-gray-900 text-center mb-8">
            ...
            <div className="bg-gray-50 border-2 border-gray-900 rounded-md p-6">
              <p className="text-gray-900 leading-relaxed">
                ...
                immutable, tamper-proof, and permanently accessible through your
                Solana wallet. With Solana's scalability and eco-friendly
                consensus, you can journal daily without worrying about high
                fees or slow transactions. This creates a verifiable, lifelong
                record of your thoughts and emotions that only you
                control—perfect for web3 enthusiasts and privacy-conscious users
                who value true data ownership.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-gray-900 rounded-md p-8 text-center">
            <h2 className="font-['Kalam'] text-2xl font-bold text-gray-900 mb-4">
              Ready for Mainnet?
            </h2>
